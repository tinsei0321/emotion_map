...
GEOJSON_COLOR_BRAND_PRIMARY = '#4285F4'
GEOJSON_COLOR_BRAND_SELECTED = '#4285F4'
GEOJSON_COLOR_CARD_FILL = '#384555'
GEOJSON_COLOR_CHROME_ACTIVE_FILL = '#4285F4'
...
GEOJSON_COLOR_PILL_BG = 'rgba(66,133,244,0.10)'
GEOJSON_COLOR_PILL_FG = '#4285F4'
...
GEOJSON_FEATURE_BOUNDARY_FILL = '#4285F4'
GEOJSON_FEATURE_BOUNDARY_FILL_OPACITY = 0.08
GEOJSON_FEATURE_BOUNDARY_STROKE = '#4285F4'
...
GEOJSON_FEATURE_SELECTION_HALO_COLOR = '#4285F4'
GEOJSON_FEATURE_SELECTION_HALO_OPACITY = 0.25
GEOJSON_FEATURE_SELECTION_HALO_SCALE = 1.8
GEOJSON_FEATURE_VERTEX_COLOR = '#4285F4'
GEOJSON_LAYOUT_COLLAPSE_BUTTON_SIZE = '40px'
GEOJSON_LAYOUT_HEADER_HEIGHT = '48px'
GEOJSON_LAYOUT_LEFT_PANEL_MAX = '1800px'
GEOJSON_LAYOUT_LEFT_PANEL_MIN = '300px'
GEOJSON_LAYOUT_LEFT_PANEL_WIDTH = '380px'
