...
GEOJSON_COLOR_TEXT_DISABLED = '#d4d4d4'
GEOJSON_COLOR_TEXT_INVERSE = '#ffffff'
GEOJSON_COLOR_TEXT_PRIMARY = '#171717'
...
GEOJSON_LAYOUT_HEADER_HEIGHT = '64px'
GEOJSON_LAYOUT_PANEL_WIDTH = '320px'
GEOJSON_LAYOUT_SPLITTER_WIDTH = '4px'
...
GEOJSON_TYPOGRAPHY_SANS = "'Open Sans', 'Inter', system-ui, -apple-system, 'Microsoft YaHei', sans-serif"
