...
PROJECTS = [
    {'id': 'URP-P01', 'city': '宜昌', 'region': '中心城区', 'topic': 'project',
     'name': '2025-2027 更新典型片区+机制项目', 'detail': '55 个（典型片区类+机制类两类项目）·总投资 51.33 亿'
     '（来源 00-03 项目库）；另 2030 核心目标含 43 个完整社区建设 + 5 个重点片区（葛洲坝/老城中心/环三峡大学/滨江商务/小溪塔中心）'
     '+ 21 个片区 + 32 个城中村改造 + 二马路/织布街历史文化街区（来源 00-02 阶段性成果·43 完整社区与 55 项目为不同口径·勿混算）',
     'dimension': '片区', 'year': '2025-2027', 'keywords': '更新项目 典型片区 机制 完整社区 重点片区 城中村',
     'source': 'docs/urban-renewal-plan/_INDEX#00-03(260713) + 00-02(0610)'},
