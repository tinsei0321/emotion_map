...
PROJECTS = [
    {'id': 'URP-P01', 'city': '宜昌', 'region': '中心城区', 'topic': 'project',
     'name': '2025-2027 更新典型片区和机制建设项目（55 个）', 'detail': '2025-2027 拟实施城市更新典型片区和机制建设项目 55 个·总投资 51.33 亿元：'
     '典型片区类 43 个 44.93 亿（87.5%）——污水"厂网一体"示范区 16 个 20.14 亿 / 葛洲坝片区 12 个 11.07 亿 / '
     '夷陵三峡移民老城片区 12 个 6.15 亿 / 红星路-二马路历史文化街区 3 个 7.57 亿；机制建设类 12 个 6.39 亿（12.5%）',
     'dimension': '片区', 'year': '2025-2027', 'keywords': '更新项目 典型片区 机制 典型片区类 机制建设类 污水厂网一体 葛洲坝 夷陵三峡移民 红星路二马路',
