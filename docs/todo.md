...
### 🔄 CB-41 双 bug 根因定位 + 台账 + dsh 排查发起（revision-log 5.257-5.259·**修复已实施·待用户验收**）
...
- **待用户验收**：体检两方面合并点 174 社区聚合 → ① 密集社区（五龙/润城/深圳路）深色·零点社区无填充 ② 悬停建设/朝阳路/五龙等 34 清单社区 tip=Table 行名·显「点数·N」 ③ 情绪点层 L2 聚合极性图不变 ④ AI 入口如旧。验收通过后 B012/B013 关账
