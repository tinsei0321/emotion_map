# Todo 归档 · 2026-07-27（周一）~ 2026-08-02（周日）

> 上周及更早的日段归档（07-28/29 + 08-01 + 08-02×2·CB-10~CB-12）。详条已在 [revision-log §5](../revision-log.md)（永久审计底）·本文件为归档索引。
> 本周（08-03 起）见 [../todo.md](../todo.md).
