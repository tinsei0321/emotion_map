...
用户开工令=统一拍板清单 1/2/11 项生效（3-9 按推荐·第 10 项待补）。新命名体系（任务代号+CB 轮次·PT-CB1 起·旧 CB 编号封存·CB-41 撞号化解）。T1 基建落账（开工档/三日志/分支并轨 EMC_harness_dsh→main 快进）✅；T2 G8a 静态契约派生（zcode 攻坚·严格档）开工；T3a/b 勘误批+干净环境设计稿派发 dsh；T4 审计章程+B6 出处追查派发 Codex+claude。PT 总计划 v1.0 转正（原 CB41 草案更名）。
