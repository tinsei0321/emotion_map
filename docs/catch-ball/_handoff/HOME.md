...
> **同步**：git push 后办公室可见。**到公司读 `OFFICE.md`**（08-11 公司续做卡·最新）。
...
- **公司待做（08-11 上午·详见 OFFICE.md）**：CB-22d 后续（准确度多实体/宜昌词典/finalStep兜底/A1 GIS/A2面化/A3项目库/B3用例）+ RAG 遗留（B路径/混合检索/全仓扫描/Recall@5）
- **接手文档**：`OFFICE.md`（08-11 公司续做卡）+ `DEEPSEEK_ONBOARDING_2026-07-30.md`（历史）
...
| 公司续做 | `docs/catch-ball/_handoff/OFFICE.md`（08-11 卡） |
