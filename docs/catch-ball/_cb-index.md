...
| 项目 | 状态 |
|------|:---:|
| **当前 CB 轮次** | **CB-21**（城市更新专项规划研究资料集 + EMC 知识库接入·**反评价收敛完成·方案定稿·待用户指示实施**） |
...
| **最新讨论** | `discuss/CB21-城市更新专项规划资料集_反评价收敛_2026-08-09.md`（CB-21·6 焦点全收敛·两组采纳合并·定稿） |
| **最新进展** | **CB-17~20 全闭环·发版候选通过**·**CB-21 方案定稿**：城市更新专项规划资料集（九目录·11 字段防张冠李戴·杭州专题·L0 资料库+L1 浓缩+L2 出向三层·待实施） |
