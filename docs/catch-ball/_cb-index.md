...
| 项目 | 状态 |
|------|:---:|
| **当前 CB 轮次** | **CB-21b**（城市更新专项规划资料集 v2·**反评价收敛完成·方案定稿·进入正式执行（三组全量读取）**） |
...
| **最新讨论** | `discuss/CB21b-城市更新专项规划资料集v2_反评价收敛_2026-08-09.md`（CB-21b·定稿·全量读取清单 + 未读清单 + 解决办法） |
| **最新进展** | **CB-17~20 全闭环**·**CB-21b 定稿**：G 盘 875 文件全量读取（zip 已拆无需处理·glm 识图/codex 文本/claude GIS 分工·13 字段提炼·三层筛选·数值不进 L1） |
