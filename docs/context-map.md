...
│  └─ docs/todo.md — 日段任务（倒序）；docs/dev-notes.md — 技术心得；docs/decisions.md — ADR；docs/debug-memory.md — **全局调试记忆（R1-R22 踩坑规则库+R7.3/R8.1 补充·多组共享·CB-41 建·含维护协议与 dsh 宿主坑·08-22 增 R20 batch 顺序/R21 跨 shell CRLF 与引号/R22 全局配置静默改写/R8.1 验证矩阵三路）**
│
