...
> **⚠ 定位（2026-06-17）**：本章（3.1~3.3）为**遗留 Streamlit** UI 规格（Folium iframe / HUD 按钮 / st.dialog）。
>
> 前端主界面 `frontend/` 的 UI 规格见 [`apps/CLAUDE.md`](../apps/CLAUDE.md)「UI 组件规范」段 + [`frontend/README.md`](../frontend/README.md)。
