...
import { applyQualityDefense, _setLastToolRowsForTest, _buildOutletCardForTest, composeGapCard, _quickIntent, _assembleKnowledgeQA, _composeDegradedConclusion } from './ai_qa/harness.js';   // G0 R9 单测 + Wave 1 出口卡直测 + ③w5 措辞断言 + CB-22 RAG 短路判定 + P0-5 合流直测 + CB-22e P2 降级结论直测
