...
export async function _assembleKnowledgeQA(ctx, hooks, opts = {}) {
  ...
  ctx.context = '【本次为知识问答·严禁图层/分析模板】\n\n' +
    ...
    '3. **每个具体数字/名词（项目数/片区数/投资额/概念定义）必须紧跟 [来源] 锚点·禁止自行拆分/合并/编造数字**·来源须用**可读名称**（完整文件名如《宜昌市中心城区城市更新专项规划260713（阶段性成果 PDF 版）》或归纳提炼的简短标题）·**不得用内部代号**（如 00-03/260713 版）·**格式统一为〔来源：可读名称〕**（中文方括号·如〔来源：《宜昌市中心城区城市更新专项规划260713》〕）；\n' +
