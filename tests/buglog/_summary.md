...
> 自动生成（`py tests/buglog/_gen_index.py`）·勿手改 · 最后更新：2026-07-29 15:57
> 条目 **8** · OPEN **7** · RESOLVED **1** · P0 阻塞 **3** · 修复已提交 **4**
> 飞轮：27 用例 · 最近报告：report-2026-07-28-01-llm (75%·15/20)
...
| 修复已提交 | 4 |
| 飞轮用例 | 27 |
| 最近飞轮报告 | report-2026-07-28-01-llm (75%·15/20) |
...
- **最近报告**：report-2026-07-28-01-llm (75%·15/20)（`tests/reports/`）
