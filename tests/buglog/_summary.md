...
> 自动生成（`py tests/buglog/_gen_index.py`）·勿手改 · 最后更新：2026-08-16 12:29
> 条目 **12** · OPEN **4** · RESOLVED **8** · P0 阻塞 **2** · 修复已提交 **3**
...
| - | - | 待修复（CB-38 E1·方向候选：A 鼠标 lngLat 实时归属+空间索引节流 / B 跨界格并列显示 / C 现状... | B012 |
...
- **B012** · 网格/地形悬停社区行张冠李戴——按格中心单点归属而非指针位置，跨界格显示邻居社区 — 2× 复现（open）
...
- **最近报告**：report-2026-08-08-05-llm (92%·24/26)（`tests/reports/`）
