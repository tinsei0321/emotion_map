...
> 自动生成（`py tests/buglog/_gen_index.py`）·勿手改。条目总数 **11**·未解决 **10**。
...
| B010 | 飞轮测试数据层命名混乱 — L2·e2e 不知所云 | [UI] | [LOW] | [OPEN] | UI | 1 | CB-09 |
| B011 | 飞轮测试每例重复加载行政区 — 图层堆叠 | [BUG] | [MED] | [OPEN] | 工具调用 | 1 | CB-09 |
